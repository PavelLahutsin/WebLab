     ...
     public class BookContextInitializer : CreateDatabaseIfNotExists<BookContext>
    {
        protected override void Seed(BookContext db)
        {
            ...
            db.Books.Add(new Book
            {
                ...
                Name = "Белый пик",
                Description = "Остросюжетный шпионский роман для детей среднего и старшего школьного возраста",
                Genre = "Детективы",
                Price = 7.17m
            });
            db.Books.Add(new Book
            ...
            db.Books.Add(new Book
            {
                ...
                Author = "	Ирвин Уэлш",
                Name = "На игле",
                Description = "Исповедь поколения, на собственной шкуре познавшего страшную справедливость девиза \"НЕТ БУДУЩЕГО\"...",
                Genre = "Роман",
                Price = 19.45m
            });
